(function ($) {
    $.fn.hoverizr = function (m) {
        ...
        if (m.overlay == "top") {
            this.parent('.' + m.container + '').parent().hover(function () {
                $(this).find('.canv').stop(true, true).fadeOut(m.speedOut)
            }, function () {
                $(this).find('.canv').stop(true, true).fadeIn(m.speedIn)
            })
        } else {
            this.parent('.' + m.container + '').hover(function () {
                $(this).find('.canv').stop(true, true).fadeIn(m.speedOut)
            }, function () {
                $(this).find('.canv').stop(true, true).fadeOut(m.speedIn)
            })
        }
    }
})(jQuery);
